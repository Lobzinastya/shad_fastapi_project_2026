# Итоговый проект, модуль Python — SHAD FastAPI

**UPDATE**: В рамках итоговой работы в приложение был добавлен seller, связь между продавцами и книгами, 
также написаны тесты на все эндпоинты с использованием pytest.

Тесты разделены на два файла (части):
- tests_books — предшествующие тесты эндпоинтов книг (переделанные под + seller)
- tests_sellers_plus — тесты продавцов и отношений Seller–Book (+ доп)

**Студент**: Анастасия Собченко
